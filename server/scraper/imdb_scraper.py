...
def get_credits_new(lst):
    searchy = 'quentin tarantino'
    ...
    testurl_3 = f'https://caching.graphql.imdb.com/?operationName=FindPageSearch&variables={{"first":1,"includeAdult":false,"isExactMatch":false,"locale":"en-US","numResults":1,"searchTerm":"{searchy}","skipHasExact":true,"typeFilter":"NAME"}}&extensions={{"persistedQuery":{{"sha256Hash":"038ff5315025edc006d874aa81178b17335fcae8fecc25bf7c2ce3f1b8085b60","version":1}}}}'
